export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-5xl font-bold mb-12 text-white bg-gradient-to-r from-white to-red-500 bg-clip-text text-transparent">프로젝트 소개</h1>

      <div className="space-y-8">
        {/* 프로젝트 개요 */}
        <section className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-8 rounded-xl border border-white/10">
          <h2 className="text-2xl font-bold mb-4 text-white">프로젝트 개요</h2>
        ...
        {/* 기술 스택 */}
        <section className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-8 rounded-xl border border-white/10">
          <h2 className="text-2xl font-bold mb-6 text-white">기술 스택</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-black/30 p-6 rounded-lg border border-white/5">
              <h3 className="font-semibold text-red-500 mb-3 text-lg">Frontend</h3>
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-white/5">
              <h3 className="font-semibold text-red-500 mb-3 text-lg">Features</h3>
              <ul className="space-y-2 text-gray-300">
                <li>• App Router</li>
              </ul>
            </div>
        ...
        {/* 데이터 출처 */}
        <section className="bg-gradient-to-br from-zinc-900 to-zinc-800 p-8 rounded-xl border border-white/10">
          <h2 className="text-2xl font-bold mb-4 text-white">데이터 출처</h2>
